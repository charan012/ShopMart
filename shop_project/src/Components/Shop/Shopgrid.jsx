...
<img src="src/assets/images/products/product-img-3.jpg" alt="Grocery Ecommerce Template" className="mb-3 img-fluid" /></Link>
                      ...
                      <h2 className="fs-6"><Link to="/Shopsingle" className="text-inherit text-decoration-none">Cadbury 5 Star</Link></h2>
                      <div className="text-warning">
                        {/* rating */}
                        <small>
                          <i className="bi bi-star-fill" />
...
<img src="src/assets/images/products/product-img-8.jpg" alt="Grocery Ecommerce Template" className="mb-3 img-fluid" /></Link>
                      ...
                      <h2 className="fs-6"><Link to="/Shopsingle" className="text-inherit text-decoration-none">Kellogg's Cereals</Link></h2>
                      <div className="text-warning">
                        {/* rating */}
                        <small>
                          <i className="bi bi-star-fill" />
