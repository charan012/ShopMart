                          ...
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-8 col-12 flex-grow-1">
                              ...
                              <div className="mt-6">
                                ...
                                {/* btn */}
                                <div className="mt-3">
                                  <a href="#!" className="btn btn-icon btn-sm btn-outline-gray-400 text-muted" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                                    <i className="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" title="Quick View" />
                                  </a>
                                  <Link to="/Shopwish" className="btn btn-icon btn-sm btn-outline-gray-400 text-muted" data-bs-toggle="tooltip" data-bs-html="true" title="Wishlist">
                                    <i className="bi bi-heart" />
                                  </Link>
                                  <a href="#!" className="btn btn-icon btn-sm btn-outline-gray-400 text-muted" data-bs-toggle="tooltip" data-bs-html="true" title="Compare">
                        ...
                        <div className="card-body">
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-8 col-12 flex-grow-1">
                              ...
                              <div className="mt-6">
                                {/* price */}
                                <div><span className="text-dark">$14</span></div>
                                {/* btn */}
                                <div className="mt-3">
                                  <a href="#!" className="btn btn-icon btn-sm btn-outline-gray-400 text-muted" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                                    <i className="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" title="Quick View" />
                            ...
                            <div className="col-md-8 col-12 flex-grow-1">
                              ...
                              <div className="mt-6">
                                ...
                                <div>
                                  ...
                                  <span className="text-decoration-line-through text-muted">$9</span>
                                </div>
                                {/* btn */}
                                <div className="mt-3">
                                  <a href="#!" className="btn btn-icon btn-sm btn-outline-gray-400 text-muted" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                            ...
                            <div className="col-md-8 col-12 flex-grow-1">
                              ...
                              <div className="mt-6">
                                ...
                                <div>
                                  ...
                                  <span className="text-decoration-line-through text-muted">$19</span>
                                </div>
                                {/* btn */}
                                <div className="mt-3">
                                  <a href="#!" className="btn btn-icon btn-sm btn-outline-gray-400 text-muted" data-bs-toggle="modal" data-bs-target="#quickViewModal">
