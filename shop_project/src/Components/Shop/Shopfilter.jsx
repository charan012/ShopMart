          ...
          <section className="mt-8 mb-lg-14 mb-8">
            <div className="container">
              ...
              <div className="row gx-10">
                <div className="col-12">
                  {/* filter btn */}
                  <a className="btn btn-outline-gray-400 text-muted" data-bs-toggle="collapse" href="#collapseFilter" role="button" aria-expanded="true" aria-controls="collapseFilter">
                        ...
                        <div className="card mb-4 mb-lg-0">
                          <div className="card-body p-6">
                            ...
                            <ul className="nav nav-category">
                              {/* nav item */}
                              <li className="nav-item border-bottom w-100"><a href="#" className="nav-link">Dairy, Bread &amp; Eggs</a></li>
                              {/* nav item */}
                              <li className="nav-item border-bottom w-100"><a href="#" className="nav-link">Snacks &amp; Munchies</a></li>
                              {/* nav item */}
                              <li className="nav-item border-bottom w-100"><a href="#" className="nav-link">Fruits &amp; Vegetables</a></li>
                              {/* nav item */}
                              <li className="nav-item border-bottom w-100"><a href="#" className="nav-link">Cold Drinks &amp; Juices</a></li>
                              {/* nav item */}
                              <li className="nav-item border-bottom w-100"><a href="#" className="nav-link">Breakfast &amp; Instant Food</a></li>
                              {/* nav item */}
                              <li className="nav-item border-bottom w-100"><a href="#" className="nav-link">Bakery &amp; Biscuits</a></li>
                              {/* nav item */}
                              <li className="nav-item"><a href="#" className="nav-link">Chicken, Meat &amp; Fish</a></li>
                            </ul>
                          </div>
                        </div>
                        {/* col */}
                    ...
                    <div className="col">
                      ...
                      <div className="card card-product">
                        <div className="card-body">
                          ...
                          <h2 className="fs-6"><Link href="/Shopsingle" className="text-inherit text-decoration-none">Haldiram's Sev Bhujia</Link></h2>
                          <div>
...
<img src="src/assets/images/products/product-img-3.jpg" alt="Grocery Ecommerce Template" className="mb-3 img-fluid" /></Link>
                          ...
                          <h2 className="fs-6"><Link href="/Shopsingle" className="text-inherit text-decoration-none">Cadbury 5 Star Chocolate</Link></h2>
                          {/* rating */}
                          <div className="text-warning">
                            <small>
                              <i className="bi bi-star-fill" />
                    ...
                    <div className="col">
                      ...
                      <div className="card card-product">
                        <div className="card-body">
                          ...
                          <h2 className="fs-6"><Link href="/Shopsingle" className="text-inherit text-decoration-none">Onion Flavour Potato</Link></h2>
                          {/* rating */}
                          <div className="text-warning">
                            <small>
                              <i className="bi bi-star-fill" />
                    ...
                    <div className="col">
                      ...
                      <div className="card card-product">
                        <div className="card-body">
                          ...
                          <h2 className="fs-6"><Link href="/Shopsingle" className="text-inherit text-decoration-none">Blueberry Greek Yogurt</Link></h2>
                          <div>
                            <small className="text-warning">
                              <i className="bi bi-star-fill" />
                              <i className="bi bi-star-fill" />
...
<img src="src/assets/images/products/product-img-9.jpg" alt="Grocery Ecommerce Template" className="mb-3 img-fluid" /></Link>
                    ...
                    <div className="col">
                      ...
                      <div className="card card-product">
                        <div className="card-body">
                          <div className="text-center position-relative">
                            <Link to="/Shopsingle"><img src="src/assets/images/products/product-img-10.jpg" alt="Grocery Ecommerce Template" className="mb-3 img-fluid" /></Link>
                            {/* action btn */}
                            <div className="card-product-action">
                              <a href="#!" className="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                                <i className="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" title="Quick View" />
