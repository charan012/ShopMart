              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="mb-6 border-end-lg p-md-4 px-xl-12 text-center">
                  <div>
                    ...
                    {/* text */}
                    <h3 className="fs-5 mb-3">Cheapest basket 25 years running</h3>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="mb-6 border-end-lg p-md-4 px-xl-12 text-center">
                  <div>
                    ...
                    {/* text */}
                    <h3 className="fs-5 mb-3">Best Prices &amp; Offers</h3>
                    <p className="mb-0">Cheaper prices than your local supermarket, great cashback offers to top it off.</p>
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-12">
                <div className="mb-6 p-md-4 px-xl-12 text-center">
                  <div>
                    ...
                    {/* text */}
                    <h3 className="fs-5 mb-3">Wide Assortment</h3>
                    <p className="mb-0">Choose from 5000+ products across food, personal care, household &amp; other categories</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6 col-12">
                ...
                <div className="mb-6 border-end-lg p-md-4 px-xl-12 text-center">
                  <div>
                    <div className="mb-8">
                      {/* svg */}
                      <svg xmlns="http://www.w3.org/2000/svg" width={34} height={34} fill="currentColor" className="bi bi-tablet text-primary" viewBox="0 0 16 16">
                        <path d="M12 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h8zM4 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H4z" />
                        <path d="M8 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" />
                      </svg>
                    </div>
                    {/* text */}
                    <h3 className="fs-5 mb-3">Shop with our app</h3>
                    <p className="mb-0">
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="mb-6 border-end-lg p-md-4 px-xl-12 text-center">
                  <div>
                    <div className="mb-8">
                      {/* svg */}
                      <svg xmlns="http://www.w3.org/2000/svg" width={34} height={34} fill="currentColor" className="bi bi-truck text-primary" viewBox="0 0 16 16">
                        <path d="M0 3.5A1.5 1.5 0 0 1 1.5 2h9A1.5 1.5 0 0 1 12 3.5V5h1.02a1.5 1.5 0 0 1 1.17.563l1.481 1.85a1.5 1.5 0 0 1 .329.938V10.5a1.5 1.5 0 0 1-1.5 1.5H14a2 2 0 1 1-4 0H5a2 2 0 1 1-3.998-.085A1.5 1.5 0 0 1 0 10.5v-7zm1.294 7.456A1.999 1.999 0 0 1 4.732 11h5.536a2.01 2.01 0 0 1 .732-.732V3.5a.5.5 0 0 0-.5-.5h-9a.5.5 0 0 0-.5.5v7a.5.5 0 0 0 .294.456zM12 10a2 2 0 0 1 1.732 1h.768a.5.5 0 0 0 .5-.5V8.35a.5.5 0 0 0-.11-.312l-1.48-1.85A.5.5 0 0 0 13.02 6H12v4zm-9 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm9 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" />
                      </svg>
                    </div>
                    {/* text */}
                    <h3 className="fs-5 mb-3">Want your shopping today?</h3>
                    <p className="mb-0">
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="mb-6 p-md-4 px-xl-12 text-center">
                  <div>
                    <div className="mb-8">
                      {/* svg */}
                      <svg xmlns="http://www.w3.org/2000/svg" width={34} height={34} fill="currentColor" className="bi bi-arrow-repeat text-primary" viewBox="0 0 16 16">
                        <path d="M11.534 7h3.932a.25.25 0 0 1 .192.41l-1.966 2.36a.25.25 0 0 1-.384 0l-1.966-2.36a.25.25 0 0 1 .192-.41zm-11 2h3.932a.25.25 0 0 0 .192-.41L2.692 6.23a.25.25 0 0 0-.384 0L.342 8.59A.25.25 0 0 0 .534 9z" />
                        <path fillRule="evenodd" d="M8 3c-1.552 0-2.94.707-3.857 1.818a.5.5 0 1 1-.771-.636A6.002 6.002 0 0 1 13.917 7H12.9A5.002 5.002 0 0 0 8 3zM3.1 9a5.002 5.002 0 0 0 8.757 2.182.5.5 0 1 1 .771.636A6.002 6.002 0 0 1 2.083 9H3.1z" />
                      </svg>
                    </div>
                    {/* text */}
                    <h3 className="fs-5 mb-3">Easy Returns/Refund</h3>
                    <p className="mb-0">
