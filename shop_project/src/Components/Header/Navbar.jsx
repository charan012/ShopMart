                     ...
                     <ul className="navbar-nav align-items-center">
                        <li className="dropdown me-3 d-none d-lg-block">
                           ...
                           <ul className="dropdown-menu dropdown-menu-lg">
                              <li className="dropdown-menu-list">
                                 <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item d-flex justify-content-between mb-1 py-1">
                                    <div>
                                 ...
                                 <div className="dropdown-menu-list-submenu">
                                    <div>
                                       <ul className="list-unstyled">
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Fresh Vegetables</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Herbs &amp; Seasonings</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Fresh Fruits</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Organic Fruits &amp; Vegetables</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Cuts &amp; Sprouts</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Exotic Fruits &amp; Veggies</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Flower Bouquets, Bunches</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Specialty</a>
                                          </li>
                                       </ul>
                                    </div>
                                    ...
                                    <div>
                                       <ul className="list-unstyled">
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Banana &amp; Papaya</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Kiwi, Citrus Fruit</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Apples &amp; Pomegranate</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Seasonal Fruits</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Mangoes</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Fruit Baskets</a>
                                          </li>
                                       </ul>
                                    </div>
                                 </div>
                              ...
                              <li className="dropdown-menu-list">
                                 <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item d-flex justify-content-between mb-1 py-1">
                                    <div>
                                       ...
                                       <span className="ms-1">Grocery &amp; Kitchen</span>
                                    </div>
                                    <div>
                                       <i className="feather-icon icon-chevron-right"></i>
                                    </div>
                                 ...
                                 <div className="dropdown-menu-list-submenu">
                                    <div>
                                       <ul className="list-unstyled">
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Chips &amp; Crisps</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Nachos</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Popcorn</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Bhujia &amp; Mixtures</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Namkeen Snacks</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Healthy Snacks</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Cakes &amp; Rolls</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Energy Bars</a>
                                          </li>
                                       </ul>
                                    </div>
                                    ...
                                    <div>
                                       <ul className="list-unstyled">
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Papad &amp; Fryums</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Glucose &amp; Milk Biscuits</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Glucose &amp; Milk Biscuits</a>
                                          </li>
                              ...
                              <li className="dropdown-menu-list">
                                 <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item d-flex justify-content-between mb-1 py-1">
                                    <div>
                                       ...
                                       <span className="ms-1">Bakery, Snacks &amp; Munchies</span>
                                    </div>
                                    <div>
                                       <i className="feather-icon icon-chevron-right"></i>
                                    </div>
                                 ...
                                 <div className="dropdown-menu-list-submenu">
                                    <div>
                                       <ul className="list-unstyled">
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Cookies</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Glucose &amp; Marie</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Sweet &amp; Salty</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Healthy &amp; Digestive</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Cream Biscuits</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Rusks &amp; Wafers</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Cakes &amp; Rolls</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Buns &amp; Bakery</a>
                                          </li>
                                       </ul>
                                    </div>
                              ...
                              <li className="dropdown-menu-list">
                                 <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item d-flex justify-content-between mb-1 py-1">
                                    <div>
                                       ...
                                       <span className="ms-1">Cold Drinks &amp; Juices</span>
                                    </div>
                                    <div>
                                       <i className="feather-icon icon-chevron-right"></i>
                                    </div>
                                 ...
                                 <div className="dropdown-menu-list-submenu">
                                    <div>
                                       <ul className="list-unstyled">
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Soft Drinks</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Fruit Juices</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Coldpress</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Energy Drinks</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Water &amp; Ice Cubes</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Soda &amp; Mixers</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Concentrates &amp; Syrups</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Detox &amp; Energy Drinks</a>
                                          </li>
                                       </ul>
                                    </div>
                                    ...
                                    <div>
                                       <ul className="list-unstyled">
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Juice Collection</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Concentrates &amp; Syrups</a>
                                          </li>
                              ...
                              <li className="dropdown-menu-list">
                                 <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item d-flex justify-content-between mb-1 py-1">
                                    <div>
                                       ...
                                       <span className="ms-1">Dairy Products</span>
                                    </div>
                                    <div>
                                       <i className="feather-icon icon-chevron-right"></i>
                                    </div>
                                 ...
                                 <div className="dropdown-menu-list-submenu">
                                    <div>
                                       <ul className="list-unstyled">
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Milk</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Milk Drinks</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Curd &amp; Yogurt</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Eggs</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Bread</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Buns &amp; Bakery</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Butter &amp; More</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Cheese</a>
                                          </li>
                                       </ul>
                                    </div>
                                    ...
                                    <div>
                                       <ul className="list-unstyled">
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Paneer &amp; Tofu</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Cream &amp; Whitener</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Condensed Milk</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Vegan Drinks</a>
                                          </li>
                                       </ul>
                                    </div>
                                 </div>
                              ...
                              <li className="dropdown-menu-list">
                                 <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item d-flex justify-content-between mb-1 py-1">
                                    <div>
                                       ...
                                       <span className="ms-1">Meat, Fish &amp; Eggs</span>
                                    </div>
                                    <div>
                                       <i className="feather-icon icon-chevron-right"></i>
                                    </div>
                                 ...
                                 <div className="dropdown-menu-list-submenu">
                                    <div>
                                       <ul className="list-unstyled">
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Chicken</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Sausage, Salami &amp; Ham</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Exotic Meat</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Eggs</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Frozen Non-Veg Snacks</a>
                                          </li>
                                       </ul>
                                    </div>
                                 </div>
                              ...
                              <li className="dropdown-menu-list">
                                 <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item d-flex justify-content-between mb-1 py-1">
                                    <div>
                                       ...
                                       <span className="ms-1">Baby Care</span>
                                    </div>
                                    <div>
                                       <i className="feather-icon icon-chevron-right"></i>
                                    </div>
                                 ...
                                 <div className="dropdown-menu-list-submenu">
                                    <div>
                                       <ul className="list-unstyled">
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Diapers, Wipes &amp; More</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Baby Food</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Bath &amp; Hair Care</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Oral &amp; Nasal Care</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Baby Skin Care Online</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Cleaning Needs Online</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Feeding Accessories Online</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Baby Pharma</a>
                                          </li>
                                       </ul>
                                    </div>
                                    ...
                                    <div>
                                       <ul className="list-unstyled">
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Mother Care</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Baby Gift Set</a>
                                          </li>
                                          <li>
                                             <a href="#" onClick={(e) => e.preventDefault()} className="dropdown-item">Kids Toys &amp; More</a>
                                          </li>
                                       </ul>
                                    </div>
                                 </div>
                           ...
                           <div className="dropdown-menu pb-0">
                              <div className="row p-2 p-lg-4">
                                   <div className="col-lg-3 col-12 mb-4 mb-lg-0">
                                      <h6 className="text-primary ps-3">Dairy Products</h6>
                        ...
                        <li className="nav-item dropdown">
                           ...
                           <ul className="dropdown-menu">
                              ...
                              <li><Link  to="/BlogSingle" className="dropdown-item" >Blog Single</Link></li>
                              <li><Link  to="/BlogCategory" className="dropdown-item" >Blog Category</Link></li>
