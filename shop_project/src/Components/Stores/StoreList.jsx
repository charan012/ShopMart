              ...
              <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 g-lg-4">
                ...
                <div className="col">
                  ...
                  <div className="card flex-row p-8 card-product">
                    ...
                    {/* content */}
                    <div className="ms-6">
                      <h5 className="mb-1"><a href="#!" className="text-inherit">E-Grocery Super Market</a></h5>
                ...
                <div className="col">
                  ...
                  <div className="card flex-row p-8 card-product">
                    <div>
                      {/* img */}
                      <img src=" assets/images/stores-logo/stores-logo-2.svg" alt="" className="rounded-circle icon-shape icon-xl" />
                    </div>
                    {/* content */}
                    <div className="ms-6">
                      <h5 className="mb-1"><a href="#!" className="text-inherit">DealShare Mart</a></h5>
                      <div className="small text-muted">
                        <span>Alcohol</span>
                        <span className="mx-1">
                          <svg xmlns="http://www.w3.org/2000/svg" width={4} height={4} fill="#C1C7C6" className="bi bi-circle-fill align-middle" viewBox="0 0 16 16">
                ...
                <div className="col">
                  ...
                  <div className="card flex-row p-8 card-product">
                    <div>
                      {/* img */}
                      <img src=" assets/images/stores-logo/stores-logo-3.svg" alt="" className="rounded-circle icon-shape icon-xl" />
                    </div>
                    {/* content */}
                    <div className="ms-6">
                      <h5 className="mb-1"><a href="#!" className="text-inherit">DMart</a></h5>
                      <div className="small text-muted">
                        <span>Groceries</span>
                        <span className="mx-1">
                          <svg xmlns="http://www.w3.org/2000/svg" width={4} height={4} fill="#C1C7C6" className="bi bi-circle-fill align-middle" viewBox="0 0 16 16">
                ...
                <div className="col">
                  ...
                  <div className="card flex-row p-8 card-product">
                    <div>
                      {/* img */}
                      <img src=" assets/images/stores-logo/stores-logo-4.svg" alt="" className="rounded-circle icon-shape icon-xl" />
                    </div>
                    {/* content */}
                    <div className="ms-6">
                      <h5 className="mb-1"><a href="#!" className="text-inherit">Blinkit Store</a></h5>
                      <div className="small text-muted">
                        <span>Meal Kits</span>
                        <span className="mx-1">
                          <svg xmlns="http://www.w3.org/2000/svg" width={4} height={4} fill="#C1C7C6" className="bi bi-circle-fill align-middle" viewBox="0 0 16 16">
                ...
                <div className="col">
                  ...
                  <div className="card flex-row p-8 card-product">
                    ...
                    {/* content */}
                    <div className="ms-6">
                      <h5 className="mb-1"><a href="#!" className="text-inherit">StoreFront Super Market</a></h5>
                      <div className="small text-muted">
                        <span>Groceries</span>
                        <span className="mx-1">
                          <svg xmlns="http://www.w3.org/2000/svg" width={4} height={4} fill="#C1C7C6" className="bi bi-circle-fill align-middle" viewBox="0 0 16 16">
                ...
                <div className="col">
                  ...
                  <div className="card flex-row p-8 card-product">
                    <div>
                      {/* img */}
                      <img src="src/assets/images/logo/logo.png6.svg" alt="" className="rounded-circle icon-shape icon-xl" />
                    </div>
                    {/* content */}
                    <div className="ms-6">
                      <h5 className="mb-1"><a href="#!" className="text-inherit">BigBasket</a></h5>
                      <div className="small text-muted">
                        <span>Groceries</span>
                        <span className="mx-1">
                          <svg xmlns="http://www.w3.org/2000/svg" width={4} height={4} fill="#C1C7C6" className="bi bi-circle-fill align-middle" viewBox="0 0 16 16">
                ...
                <div className="col">
                  ...
                  <div className="card flex-row p-8 card-product">
                    <div>
                      {/* img */}
                      <img src=" assets/images/stores-logo/stores-logo-7.svg" alt="" className="rounded-circle icon-shape icon-xl" />
                    </div>
                    {/* content */}
                    <div className="ms-6">
                      <h5 className="mb-1"><a href="#!" className="text-inherit">Swiggy Instamart</a></h5>
                      <div className="small text-muted">
                        <span>Meal Kits</span>
                        <span className="mx-1">
                          <svg xmlns="http://www.w3.org/2000/svg" width={4} height={4} fill="#C1C7C6" className="bi bi-circle-fill align-middle" viewBox="0 0 16 16">
                ...
                <div className="col">
                  ...
                  <div className="card flex-row p-8 card-product">
                    <div>
                      {/* img */}
                      <img src=" assets/images/stores-logo/stores-logo-8.svg" alt="" className="rounded-circle icon-shape icon-xl" />
                    </div>
                    {/* content */}
                    <div className="ms-6">
                      <h5 className="mb-1"><a href="#!" className="text-inherit">Online Grocery Mart</a></h5>
                      <div className="small text-muted">
                        <span>Groceries</span>
                        <span className="mx-1">
                          <svg xmlns="http://www.w3.org/2000/svg" width={4} height={4} fill="#C1C7C6" className="bi bi-circle-fill align-middle" viewBox="0 0 16 16">
                ...
                <div className="col">
                  ...
                  <div className="card flex-row p-8 card-product">
                    <div>
                      {/* img */}
                      <img src=" assets/images/stores-logo/stores-logo-9.svg" alt="" className="rounded-circle icon-shape icon-xl" />
                    </div>
                    {/* content */}
                    <div className="ms-6">
                      <h5 className="mb-1"><a href="#!" className="text-inherit">Spencers</a></h5>
                      <div className="small text-muted">
                        <span>Groceries</span>
                        <span className="mx-1">
                          <svg xmlns="http://www.w3.org/2000/svg" width={4} height={4} fill="#C1C7C6" className="bi bi-circle-fill align-middle" viewBox="0 0 16 16">
              ...
              <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 g-lg-4">
                ...
                <div className="col">
                  ...
                  <div className="card flex-row p-8 card-product">
                    <div>
                      {/* img */}
                      <img src=" assets/images/stores-logo/stores-logo-5.svg" alt="" className="rounded-circle icon-shape icon-xl" />
                    </div>
                    {/* content */}
                    <div className="ms-6">
                      <h5 className="mb-1"><a href="#!" className="text-inherit">StoreFront Super Market</a></h5>
                ...
                <div className="col">
                  ...
                  <div className="card flex-row p-8 card-product">
                    <div>
                      {/* img */}
                      <img src=" assets/images/stores-logo/stores-logo-6.svg" alt="" className="rounded-circle icon-shape icon-xl" />
                    </div>
                    {/* content */}
                    <div className="ms-6">
                      <h5 className="mb-1"><a href="#!" className="text-inherit">BigBasket</a></h5>
