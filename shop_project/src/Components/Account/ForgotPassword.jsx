                ...
                <form className="needs-validation" noValidate>
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-12 d-grid gap-2">
                      ...
                      <Link to="/Signin" className="btn btn-light">Back</Link>
                    </div>
                  </div>
                </form>
              </div>
...
//       const response = await fetch('https://technxt.in/demo_api/forgot_password.php', {
//         method: 'POST',
//         headers: {
...
//       } else {
//         setMessage(data.message || 'Error sending recovery email.');
//       }
//     } catch (error) {
...
//           <div className="mb-3">
//             <label htmlFor="formForgetEmail" className="form-label">Email address</label>
//             <input
//               type="email"
...
//           <div className="col-12 d-grid gap-2">
//             <button type="submit" className="btn btn-primary">Reset Password</button>
//             <Link to="/Signin" className="btn btn-light">Back To SignIn</Link>
//           </div>
