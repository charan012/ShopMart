...
const Signup = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    phonenumber: Yup.string()
      .matches(/^\d+$/, 'Phone number must contain only digits') // Ensure only digits
      .length(10, 'Phone number must be 10 digits') // Ensure exact 10 digits
  ...
  // Handle form data change and validation
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://technxt.in/demo_api/regestration.php', formData, {
        headers: {
          'Content-Type': 'application/json',
        },
      });
      setMessage(response.data.message);
      setMessageColor(response.data.status === "success" ? "green" : "red");
    } catch (validationError) {
  ...
  <nav className="navbar navbar-light py-2">
    <div className="container justify-content-center justify-content-lg-between">
      <Link className="navbar-brand" to="/">
        <img src="src/assets/images/logo/logo.png" alt="" className="d-inline-block align-text-top" />
      </Link>
              ...
              <div className="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
                ...
                <form className="needs-validation" noValidate onSubmit={handleSubmit}>
                  <div className="row g-3">
                    {/* First Name */}
                    <div className="col">
                      <label htmlFor="formSignupfirstname" className="form-label visually-hidden">
                        First Name
                      </label>
                      <input
                        type="text"
                    ...
                    {/* Last Name */}
                    <div className="col">
                      <label htmlFor="formSignuplastname" className="form-label visually-hidden">
                        Last Name
                      </label>
                      <input
                        type="text"
                    ...
                    {/* Phone Number */}
                    <div className="col-12">
                      <label htmlFor="formSignupPhone" className="form-label visually-hidden">
                        Phone Number
                      </label>
                      <input
                        type="tel"
                    ...
                    {/* Type */}
                    <div className="col-12">
                      <label htmlFor="formSignupType" className="form-label visually-hidden">
                        Type
                      </label>
