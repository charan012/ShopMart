...
const Signin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://technxt.in/demo_api/users_data.php', loginData, {
  ...
  const handleEmailChange = (e) => {
    ...
    //It Shows error while typing an invalid email
        ...
        <section className="my-lg-14 my-8">
          <div className="container">
            <div className="row justify-content-center align-items-center">
              <div className="col-12 col-md-6 col-lg-4 order-lg-1 order-2"></div>
