              ...
              <div className="col-12">
                ...
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb mb-0">
                    ...
                    <li className="breadcrumb-item active" aria-current="page">Freshcart Blog</li>
                  </ol>
                </nav>
              </div>
            </div>
            ...
            <div className="row d-flex align-items-center mb-8">
              <div className="col-12 col-md-12 col-lg-8">
                <a href="#!">
                  ...
                  <div className="img-zoom">
                    <img src="src/assets/images/blog/blog-large.jpg" alt="" className="img-fluid w-100" />
                  </div>
                </a>
              </div>
              {/* text */}
              <div className="col-12 col-md-12 col-lg-4">
                <div className="ps-lg-8 mt-8 mt-lg-0">
                  <h2 className="mb-3"><a href="#!" className="text-inherit">Garlic Cream Bucatini with Peas and Asparagus</a></h2>
                  <p>
