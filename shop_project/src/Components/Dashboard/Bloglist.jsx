					...
					<li className="nav-item">
					  ...
					  <div id="navCategoriesOrders" className="collapse " data-bs-parent="#sideNavbar">
						<ul className="nav flex-column">
						  <li className="nav-item">
							<Link className="nav-link  active " to="/Orderlist">List</Link>
						  </li>
						  {/* Nav item */}
						  <li className="nav-item">
					...
					<li className="nav-item">
					  ...
					  <div id="navBlog" className="collapse  show " data-bs-parent="#sideNavbar">
						<ul className="nav flex-column">
						  ...
						  {/* Nav item */}
						  <li className="nav-item">
							<Link className="nav-link  active " to="/Bloglist">List</Link>
						  </li>
						  {/* Nav item */}
						  <li className="nav-item">
					  ...
					  <div className="row g-1 p-4">
						<div className="col-md-4">
						  <div className="img-zoom">
							<Link to="/Blogsingle">
							  <img src="src/assets/images/blog/blog-img-1.jpg" alt="blog img" className="rounded-3 object-fit-cover thumbnail-cover-img" />
							</Link>
						  </div>
						</div>
						  ...
						  <div className="card-body d-flex flex-column gap-4 gap-lg-8 h-100">
							<div className="d-flex flex-column gap-4">
							  ...
							  <h3 className="mb-0 h5">
								<Link to="/Blogsingle" className="text-reset">Quickly get a project started Bootstrap 5 Example</Link>
							  </h3>
							</div>
					...
					<div className="card card-lg rounded-4 border-0 card-lift">
					  <div className="row g-1 p-4">
						<div className="col-md-4">
						  <div className="img-zoom">
							<Link to="/Blogsingle">
							  <img src="src/assets/images/blog/blog-img-2.jpg" alt="blog img" className="rounded-3 object-fit-cover thumbnail-cover-img" />
							</Link>
						  </div>
						</div>
						<div className="col-md-8">
					...
					<div className="card card-lg rounded-4 border-0 card-lift">
					  <div className="row g-1 p-4">
						<div className="col-md-4">
						  <div className="img-zoom">
							<Link to="/Blogsingle">
							  <img src="src/assets/images/blog/blog-img-3.jpg" alt="blog img" className="rounded-3 object-fit-cover thumbnail-cover-img" />
							</Link>
						  </div>
						</div>
						<div className="col-md-8">
					...
					<div className="card card-lg rounded-4 border-0 card-lift">
					  <div className="row g-1 p-4">
						<div className="col-md-4">
						  <div className="img-zoom">
							<Link to="/Blogsingle">
							  <img src="src/assets/images/blog/blog-img-4.jpg" alt="blog img" className="rounded-3 object-fit-cover thumbnail-cover-img" />
							</Link>
						  </div>
						</div>
						<div className="col-md-8">
					...
					<div className="card card-lg rounded-4 border-0 card-lift">
					  <div className="row g-1 p-4">
						<div className="col-md-4">
						  <div className="img-zoom">
							<Link to="/Blogsingle">
							  <img src="src/assets/images/blog/blog-img-5.jpg" alt="blog img" className="rounded-3 object-fit-cover thumbnail-cover-img" />
							</Link>
						  </div>
						</div>
						<div className="col-md-8">
					...
					<div className="card card-lg rounded-4 border-0 card-lift">
					  <div className="row g-1 p-4">
						<div className="col-md-4">
						  <div className="img-zoom">
							<Link to="/Blogsingle">
							  <img src="src/assets/images/blog/blog-img-9.jpg" alt="blog img" className="rounded-3 object-fit-cover thumbnail-cover-img" />
							</Link>
						  </div>
						</div>
						<div className="col-md-8">
					...
					<div className="card card-lg rounded-4 border-0 card-lift">
					  <div className="row g-1 p-4">
						<div className="col-md-4">
						  <div className="img-zoom">
							<Link to="/Blogsingle">
							  <img src="src/assets/images/blog/blog-img-7.jpg" alt="blog img" className="rounded-3 object-fit-cover thumbnail-cover-img" />
							</Link>
						  </div>
						</div>
						<div className="col-md-8">
					...
					<div className="card card-lg rounded-4 border-0 card-lift">
					  <div className="row g-1 p-4">
						<div className="col-md-4">
						  <div className="img-zoom">
							<Link to="/Blogsingle">
							  <img src="src/assets/images/blog/blog-img-8.jpg" alt="blog img" className="rounded-3 object-fit-cover thumbnail-cover-img" />
							</Link>
						  </div>
						</div>
						<div className="col-md-8">
