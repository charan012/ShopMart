    ...
    <>
      ...
      <form onSubmit={handleSubmit}>
        <div className="form-group" style={{ marginBottom: '20px' }}>
          ...
          <input type="file" id="profileImage" onChange={handleImageUpload} accept="image/*" />
          {imagePreview ? (
            <img src={imagePreview} alt="Profile Preview" style={{ width: '130px', height: '130px', borderRadius: '50%', marginTop: '10px' }} />
          ) : (
            <img
              src="https://via.placeholder.com/100"
              alt="Default Profile"
              style={{ width: '130px', height: '130px', borderRadius: '50%', marginTop: '10px' }}
            />
          )}
        </div>
