					...
					<li className="nav-item">
					  ...
					  <div id="navBlog" className="collapse  show " data-bs-parent="#sideNavbar">
						<ul className="nav flex-column">
						  ...
						  {/* Nav item */}
						  <li className="nav-item">
							<Link className="nav-link  active " to="/Blognewpost">Add Post</Link>
						  </li>
						</ul>
					  </div>
					</li>
					...
					<div>
					  ...
					  <nav aria-label="breadcrumb">
						<ol className="breadcrumb mb-0">
						  ...
						  <li className="breadcrumb-item"><a href="#" className="text-inherit">Blog</a></li>
					  ...
					  <div className="col-lg-8 col-12">
						<div className="card card-lg">
						  <div className="card-body p-6 d-flex flex-column gap-3">
							<div className="col-12">
							  {/* input */}
							  <label htmlFor="blognewTitle" className="form-label">Title</label>
							  <input type="text" className="form-control" id="blognewTitle" placeholder="Post Title" required />
							...
							<div className="col-12">
							  ...
							  {/* input */}
							  <div id="my-dropzone" className="dropzone border-dashed rounded-2 min-h-0" />
							</div>
							<div className="col-12">
							  <label htmlFor="blogdescriptionTextarea" className="form-label">Short Descriptions</label>
							  <textarea className="form-control" id="blogdescriptionTextarea" row={5} placeholder="Write a short description" required defaultValue={""} />
						  ...
						  <div className="card-body p-6 d-flex flex-column gap-3">
							  ...
							  <div className="d-flex flex-column gap-3">
								...
								<div>
								  <div>
									...
									<input name="tags" id="tags" defaultValue="[{&quot;value&quot;:&quot;grocery&quot;, &quot;editable&quot;:false}, {&quot;value&quot;:&quot;shop&quot;}]" className="w-100" placeholder="Tags" required />
							...
							<div className="col-12">
							  <div className="d-flex flex-column gap-2">
								<div>
								  <label htmlFor="blognewContent" className="form-label">SEO Content</label>
								  <input type="text" className="form-control" id="blognewContent" placeholder="Meta Title" required />
								  <div className="invalid-feedback">Please enter seo content</div>
								</div>
								<div>
								  <label htmlFor="blogdeseoTextarea" className="form-label visually-hidden">Content</label>
								  <textarea className="form-control" id="blogdeseoTextarea" row={7} placeholder="Meta Descriptions" required defaultValue={""} />
								  <div className="invalid-feedback">Please enter a message in the textarea.</div>
								</div>
							  </div>
							</div>
							<div className="col-12">
							  <div className="form-check form-switch ps-0">
								...
								<input className="form-check-input ms-auto" type="checkbox" role="switch" id="flexSwitchCheckDefault" defaultChecked />
							  </div>
							</div>
							<div className="col-12">
							  <div className="form-check form-switch ps-0">
								<label className="form-check-label" htmlFor="flexSwitchCheckChecked">Enable comments</label>
								<input className="form-check-input ms-auto" type="checkbox" role="switch" id="flexSwitchCheckChecked" />
							  </div>
							</div>
							<div className="col-12">
							  <div className="d-flex flex-row gap-2">
								<button className="btn btn-primary w-100" type="submit">Post</button>
								<button className="btn btn-light w-100" type="button">Preview</button>
							  </div>
							</div>
						  </div>
						</div>
