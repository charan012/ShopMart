				...
				<div className="row mb-8">
				  <div className="col-md-12">
					<div className="d-md-flex justify-content-between align-items-center">
					  ...
					  <div>
						<Link to="/Categories" className="btn btn-light">Back to Categories</Link>
					  </div>
					</div>
				  </div>
				</div>
					  ...
					  <div className="card-body p-6">
						...
						<div className="mb-4 d-flex">
						  <div className="position-relative">
							<img className="image icon-shape icon-xxxl bg-light rounded-4" src="https://freshcart.codescandy.com/assets/images/icons/bakery.svg" alt="Image" />
						...
						<div className="row">
						  ...
						  <div className="mb-3 col-lg-12 mt-5">
							...
							<div className="mb-3">
							  ...
							  <textarea className="form-control" rows={3} placeholder="Meta Description" defaultValue={""} />
							</div>
						  </div>
						  <div className="col-lg-12">
							<a href="#" className="btn btn-primary">Create Product</a>
							<a href="#" className="btn btn-secondary ms-2">Save</a>
						  </div>
						</div>
					  </div>
					</div>
